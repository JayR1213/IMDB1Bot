...
# Bot information
SESSION = environ.get('SESSION', 'ImdbMoviesFiles_Bot')
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/iPopcornGroup')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/IPopcornchannel')
